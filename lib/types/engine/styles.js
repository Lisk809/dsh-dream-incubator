...
export function isDreamStyle(value) {
 ...
 */
export function rotationOffset(rotationDays, epochDays) {
 ...
 */
export function rotatedStyles(offset) {
 ...
 */
export function coerceScan(raw) {
